...
def tokenize(text):
    """
    Tokenizes and lemmatizes given text.
    
    Parameters:
    text: Text to be tokenized
    
    Returns:
    clean_tokens: Returns tokens that are lemmatized , case noramlized and stripped of leading/trailing white spaces  
    """
    # tokenize text
...
def main():
    """ 
    Builds, trains and evaluates the model and also saves the model in a pickle file .
    """
